    ...
    get: {
      ...
      responses: {
        200: z.object({
          ...
          topCustomers: z.array(z.object({ name: z.string(), orderCount: z.number(), orderValue: z.number(), amountCollected: z.number(), outstandingBalance: z.number() })),
          customerAreas: z.array(z.object({ area: z.string(), customerCount: z.number(), orderCount: z.number(), orderValue: z.number(), amountCollected: z.number(), outstandingBalance: z.number() })),
        }),
      },
    },
  },

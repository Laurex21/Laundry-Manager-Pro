...
export const customers = pgTable("customers", {
  ...
  creditBalance: decimal("credit_balance", { precision: 18, scale: 6 }).default("0").notNull(),
  totalCreditAdded: decimal("total_credit_added", { precision: 18, scale: 6 }).default("0").notNull(),
  totalCreditUsed: decimal("total_credit_used", { precision: 18, scale: 6 }).default("0").notNull(),
...
export const services = pgTable("services", {
  ...
  price: decimal("price", { precision: 16, scale: 6 }).notNull(),
  category: text("category").notNull(),
  imageUrl: text("image_url"),
  active: boolean("active").default(true),
  minimumCharge: decimal("minimum_charge", { precision: 16, scale: 6 }),
...
export const orders = pgTable("orders", {
  ...
  totalAmount: decimal("total_amount", { precision: 18, scale: 6 }).notNull().default("0"),
  ...
  discount: decimal("discount", { precision: 18, scale: 6 }).default("0"),
  discountPct: decimal("discount_pct", { precision: 5, scale: 2 }).default("0"),
  discountAmount: decimal("discount_amount", { precision: 18, scale: 6 }).default("0"),
  originalPrice: decimal("original_price", { precision: 18, scale: 6 }),
  pickupCost: decimal("pickup_cost", { precision: 18, scale: 6 }).default("0"),
...
export const orderItems = pgTable("order_items", {
  ...
  priceAtOrder: decimal("price_at_order", { precision: 16, scale: 6 }).notNull(),
});
...
export const businessSettings = pgTable("business_settings", {
  ...
  receiptQrCodeBase64: text("receipt_qr_code_base64"),
  receiptQrCodeTarget: varchar("receipt_qr_code_target", { length: 1000 }).default(""),
  receiptQrCodeLabel: varchar("receipt_qr_code_label", { length: 160 }).default(""),
...
export const garmentReturnCases = pgTable("garment_return_cases", {
  ...
  rootCause: varchar("root_cause", { length: 50 }),
  responsibility: varchar("responsibility", { length: 30 }),
  estimatedCost: decimal("estimated_cost", { precision: 14, scale: 6 }).notNull().default("0"),
  correctiveAction: text("corrective_action"),
  correctiveActionDueAt: timestamp("corrective_action_due_at"),
...
export const loyaltyProgram = pgTable("loyalty_program", {
  ...
  spendAmountPerPoint: decimal("spend_amount_per_point", { precision: 12, scale: 2 }).notNull().default("500"),
  ...
  rewardPointsRequired: integer("reward_points_required").notNull().default(100),
  rewardValue: decimal("reward_value", { precision: 12, scale: 2 }).notNull().default("500"),

...
type StatusType = "received" | "sorting" | "washing" | "stain_treatment" | "drying" | "ironing" | "packaging" | "ready" | "delivered" | "cancelled" | "pending" | "processing" | "paid" | "unpaid" | "partial";
...
const STATUS_CONFIG: Record<StatusType, { label: string; className: string }> = {
  ...
  sorting: { label: "Sorting", className: "bg-amber-100 text-amber-700 border-amber-200 dark:bg-amber-900/30 dark:text-amber-400 dark:border-amber-800" },
  ...
  packaging: { label: "Packaging", className: "bg-indigo-100 text-indigo-700 border-indigo-200 dark:bg-indigo-900/30 dark:text-indigo-400 dark:border-indigo-800" },

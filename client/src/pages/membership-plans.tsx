...
export default function MembershipPlansPage() {
  ...
  return <div className="space-y-6 page-fade-in">
    ...
    <Tabs value="plans" onValueChange={(value) => { if (value !== "plans") navigate(`/subscription-dashboard?view=${value}`); }}><TabsList aria-label="Subscription management views"><TabsTrigger value="plans">Plans</TabsTrigger><TabsTrigger value="subscribers">Subscribers</TabsTrigger><TabsTrigger value="revenue">Revenue</TabsTrigger></TabsList></Tabs>

...
<title>Diagnostic Pressing — ${form.fullName || "CleanEase"}</title>
<style>
...
<div class="cta">
  ...
  <span style="font-size:13px;color:#1e40af">Digitalisez votre pressing avec CleanEase — gestion des commandes, clients, paiements et statistiques en temps réel.</span>
</div>
<div class="footer">© ${new Date().getFullYear()} CleanEase Inc. — Tous droits réservés. Ce rapport est confidentiel.</div>
</body></html>`;
  ...
  return (
    <div className="text-center mb-8">
      <div className="inline-flex items-center gap-2 mb-4 text-primary font-semibold text-sm bg-blue-50 border border-blue-100 px-4 py-1.5 rounded-full">
        <Shirt className="w-4 h-4" /> CleanEase Diagnostic
      </div>
      ...
      <div className="max-w-2xl mx-auto px-4 py-8 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-card border border-border rounded-2xl p-6 shadow-sm">
            ...
            <Button variant="outline" className="w-full border-2 hover:bg-primary/5 hover:-translate-y-0.5 transition-all" onClick={() => window.open(`https://wa.me/?text=Bonjour, j'ai obtenu le niveau ${level.label} au diagnostic CleanEase (${totalScore}/60) et je souhaite un accompagnement.`, "_blank")}>
          ...
          <div className="bg-gradient-to-br from-blue-600 to-blue-800 text-white rounded-2xl p-6 shadow-lg">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <Button variant="outline" className="w-full border-white/40 text-white hover:bg-white/10" onClick={() => window.open("https://wa.me/?text=Bonjour, je souhaite une démo de la plateforme CleanEase.", "_blank")}>
                Demander une démo
              </Button>
            </div>
          </div>

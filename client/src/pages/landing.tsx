    ...
    <main id="main-content">
      <section className="relative min-h-[90vh] overflow-hidden bg-[#0D1B4B] pb-24 pt-28 text-white">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-4 lg:grid-cols-[1.1fr_.9fr]">
          <div className="landing-reveal"><span className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-4 py-2 text-sm"><span className="h-2 w-2 rounded-full bg-emerald-400" />{t("landing_v3.hero_badge")}</span><h1 className="mt-6 max-w-3xl text-4xl font-black leading-[1.04] tracking-tight sm:text-6xl">{t("landing_v3.hero_title")}</h1><p className="mt-6 max-w-2xl text-lg leading-8 text-blue-100">{t("landing_v3.hero_sub")}</p><div className="mt-8 flex flex-col gap-3 sm:flex-row"><Link href="/auth?tab=register" className="min-h-12 rounded-xl bg-blue-600 px-6 py-3 text-center font-bold text-white hover:bg-blue-500">{t("landing_v3.start_trial")}</Link><Link href="/calculateur" className="min-h-12 rounded-xl border border-white/35 px-6 py-3 text-center font-bold hover:bg-white/10">{t("landing_v3.calculate_profit")}</Link></div><p className="mt-4 text-sm text-blue-200">{t("landing_v3.hero_trust")}</p></div>
      ...
      <section id="tools" className="bg-[#0D1B4B] py-24 text-white"><div className="mx-auto max-w-7xl px-4"><SectionHead dark eyebrow={t("landing_v3.tools_eyebrow")} title={t("landing_v3.tools_title")} sub={t("landing_v3.tools_sub")} /><div className="mt-12 grid gap-5 lg:grid-cols-[.8fr_1.4fr_.8fr] lg:items-center"><div className="space-y-5"><Tool icon={ClipboardCheck} title={t("landing_v3.diagnostic")} desc={t("landing_v3.diagnostic_desc")} href="/auth?tab=register" /><Tool icon={Calculator} title={t("landing_v3.startup_calc")} desc={t("landing_v3.startup_calc_desc")} href="/calculateur" /></div><article className="landing-card rounded-2xl border-2 border-blue-400 bg-white p-8 text-slate-900 shadow-2xl"><span className="rounded-full bg-blue-100 px-3 py-1 text-xs font-bold text-blue-700">{t("landing_v3.most_used")}</span><Sparkles className="mt-6 h-9 w-9 text-blue-600" /><h3 className="mt-4 text-2xl font-black">{t("landing_v3.profit_calc")}</h3><p className="mt-3 leading-7 text-slate-600">{t("landing_v3.profit_calc_desc")}</p><div className="my-5 flex flex-wrap gap-2 text-xs">{["2 minutes",t("landing_v3.no_signup"),t("landing_v3.whatsapp_report")].map(x => <span key={x} className="rounded-full bg-slate-100 px-3 py-1">{x}</span>)}</div><Link href="/calculateur" className="inline-flex min-h-12 items-center gap-2 rounded-xl bg-blue-600 px-5 py-3 font-bold text-white">{t("landing_v3.calculate_profit")}<ArrowRight className="h-4 w-4" /></Link></article><div className="space-y-5"><Tool icon={BarChart3} title={t("landing_v3.health_score")} desc={t("landing_v3.health_score_desc")} href="/auth?tab=register" /><Tool icon={FileText} title={t("landing_v3.audit")} desc={t("landing_v3.audit_desc")} href="/auth?tab=register" /></div></div></div></section>
      ...
      <section className="bg-slate-50 py-24"><div className="mx-auto max-w-5xl px-4 text-center"><SectionHead eyebrow={t("landing_v3.demo_eyebrow")} title={t("landing_v3.demo_title")} sub={t("landing_v3.demo_sub")} /><div className="mt-10 aspect-video overflow-hidden rounded-2xl bg-[#0D1B4B] shadow-xl"><div className="grid h-full place-items-center text-white"><div><span className="mx-auto grid h-16 w-16 place-items-center rounded-full border-2 border-white bg-blue-600"><Play className="ml-1 h-7 w-7 fill-white" /></span><p className="mt-5 font-bold">{t("landing_v3.demo_soon")}</p><Link href="/auth?tab=register" className="mt-2 inline-block text-sm text-blue-300 underline">{t("landing_v3.demo_wait")}</Link></div></div></div><div className="mt-8 grid grid-cols-2 gap-4 md:grid-cols-4">{[[FileText,"demo_1"],[Layers3,"demo_2"],[CreditCard,"demo_3"],[BarChart3,"demo_4"]].map(([Icon,key]:any)=><div key={key} className="rounded-xl bg-white p-4 text-sm font-semibold shadow-sm"><Icon className="mx-auto mb-2 h-5 w-5 text-blue-600" />{t(`landing_v3.${key}`)}</div>)}</div><p className="mt-8">{t("landing_v3.demo_question")} <Link href="/auth?tab=register" className="font-bold text-blue-600">{t("landing_v3.start_free_arrow")}</Link></p></div></section>
      ...
      <section className="bg-[#0D1B4B] py-24 text-center text-white"><div className="mx-auto max-w-4xl px-4"><h2 className="text-3xl font-black sm:text-5xl">{t("landing_v3.final_title")}</h2><p className="mx-auto mt-5 max-w-2xl text-blue-100">{t("landing_v3.final_sub")}</p><div className="mx-auto mt-8 max-w-2xl rounded-2xl bg-white/10 p-6"><p className="text-xl font-bold">🎁 {t("landing_v3.final_offer")}</p><p className="mt-2 text-sm text-blue-200">{t("landing_v3.final_offer_sub")}</p><div className="mt-4 flex flex-wrap justify-center gap-4 text-sm">{["no_card","no_commitment","cancel_anytime"].map(k=><span key={k}>✓ {t(`landing_v3.${k}`)}</span>)}</div></div><div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row"><Link href="/auth?tab=register" className="min-h-12 rounded-xl bg-white px-6 py-3 font-bold text-blue-700">{t("landing_v3.create_account")}</Link><Link href="/calculateur" className="min-h-12 rounded-xl border border-white px-6 py-3 font-bold">{t("landing_v3.calculate_profit_plain")}</Link></div><Link href="/auth" className="mt-6 inline-block text-sm text-blue-200 underline">{t("landing_v3.already")}</Link><br/><a href="https://wa.me/237651638889" className="mt-3 inline-block text-sm text-blue-200 underline">{t("landing_v3.questions")}</a></div></section>
    </main>

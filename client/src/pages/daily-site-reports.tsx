...
export default function DailySiteReports() {
  ...
  return <div className="space-y-4 page-fade-in"><div><h1 className="text-lg font-semibold">{t("daily_reports")}</h1><p className="mt-1 text-sm text-muted-foreground">{t("daily_reports_subtitle")}</p></div>

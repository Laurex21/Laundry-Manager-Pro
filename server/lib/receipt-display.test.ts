...
assert.match(receipt, /import\("html2pdf\.js"\)/);
assert.match(receipt, /margin: \[0, 0, 0, 0\]/);
assert.match(receipt, /querySelectorAll\("\.no-print"\)/);
assert.match(receipt, /\.from\(doc\.body\)/);
...
assert.match(packageJson, /"html2pdf\.js"/);

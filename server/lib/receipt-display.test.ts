...
assert.match(receipt, /export function downloadReceiptHtml/);
...
assert.match(orderDetailPage, /serviceQuantitySummary/);
assert.match(orderDetailPage, /text-order-total-service-quantity/);
assert.match(orderDetailPage, /item\.service\?\.unit === "kg"/);
assert.match(orderDetailPage, /text-order-total-registered-garments/);
assert.match(orderDetailPage, /downloadReceiptHtml\(html, `subscriber-receipt-order-\$\{orderDisplayId\(order\)\}\.html`\)/);
assert.match(ordersPage, /downloadReceiptHtml\(html, `subscriber-receipt-order-\$\{orderDisplayId\(orderDetails\)\}\.html`\)/);

...
assert.match(orderDetailPage, /openWhatsApp\(\{ phone: readyWhatsAppPhone, text: buildCustomerWhatsAppMessage\(\) \}\)/);
assert.doesNotMatch(orderDetailPage, /https:\/\/wa\.me\/\$\{readyWhatsAppPhone\}/);
...
assert.match(ordersPage, /openWhatsApp\(\{/);
assert.match(ordersPage, /phone: createdOrderWhatsAppPhone/);
